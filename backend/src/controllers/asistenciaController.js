...
const registrar = async (req, res) => {
  try {
    const { formulario_id, grado_id, seccion_id, estudiante_id, latitud, longitud, device_id } = req.body;
    ...
    const [resultado] = await pool.query(
      `INSERT INTO asistencias (formulario_id, grado_id, seccion_id, estudiante_id, device_id, latitud, longitud, navegador)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
      [formulario_id, grado_id, seccion_id, estudiante_id, device_id || null, latitud || null, longitud || null, navegador]
    );
